...
function SignUp() {
    ...
    // État pour gérer la validation du reCAPTCHA
    const [isRecaptchaVerified, setIsRecaptchaVerified] = useState(false);
    const recaptchaRef = useRef(null);

    const handleRecaptchaChange = (value) => {
        console.log("ReCAPTCHA value:", value); // Debugging
        setIsRecaptchaVerified(!!value); // Mettre à jour l'état si le reCAPTCHA est validé
    };

    const handleRecaptchaExpired = () => {
        console.log("ReCAPTCHA expired"); // Debugging
        setIsRecaptchaVerified(false); // Réinitialiser l'état si le reCAPTCHA expire
    };
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Réinitialiser le reCAPTCHA après la soumission
