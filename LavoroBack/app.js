...
// const { getModel } = require('./utils/teamPredict');
...
// const { trainModel } = require('./utils/teamPredict');

// trainModel().then(model => {
//   performanceModel = model;
//   console.log('✅ Performance prediction model ready');
// });


// getModel().catch(err => {
//   console.error('Failed to load prediction model:', err);
//   process.exit(1);
// });
