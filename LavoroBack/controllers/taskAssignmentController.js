...
const runPythonScript = (scriptName, inputData) => {
  return new Promise((resolve, reject) => {
    // const pythonPath = 'C:\\Users\\LENOVO\\Desktop\\pidev\\PIDEV\\LavoroBack\\ml_model\\.venv\\Scripts\\python.exe';
    // const scriptPath = path.join(__dirname, '../ml_model/task_matcher.py');

    const pythonProcess = spawn(
        'C:\\Users\\LENOVO\\Desktop\\pidev\\PIDEV\\LavoroBack\\ml_model\\.venv\\Scripts\\python.exe',
        [
