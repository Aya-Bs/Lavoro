...
//     if (audioRef.current) {
//       audioRef.current.src = "https://assets.mixkit.co/active_storage/sfx/1082/1082-preview.mp3"
//       audioRef.current.volume = 0.5
//       audioRef.current.play().catch((e) => console.log("Audio play failed:", e))
//     }
//   }
...
//                 </span>
//               </li>
//               <li className="active podium-type">
//                 <a href="javascript:void(0);">
//                   <div className="d-flex align-items-center">
//                     <span className="me-2 lh-1">
//                       <i className="ti ti-trophy align-middle fs-16" />
//                     </span>
...
//                 </a>
//               </li>
//               <li className="podium-type">
//                 <a href="javascript:void(0);">
//                   <div className="d-flex align-items-center">
//                     <span className="me-2 lh-1">
//                       <i className="ti ti-users align-middle fs-16" />
//                     </span>
...
//                   <div className="d-flex align-items-center">
//                     <span className="me-2 lh-1">
//                       <i className="ti ti-settings align-middle fs-16" />
//                     </span>
...
//                   <div className="d-flex align-items-center">
//                     <span className="me-2 lh-1">
//                       <i className="ti ti-history align-middle fs-16" />
//                     </span>
//                     <span className="flex-fill text-nowrap">History</span>
//                   </div>
//                 </a>
//               </li>
//             </ul>
...
//               <h5 className="fw-semibold mb-0">Winners Podium</h5>
//               <p className="text-muted mb-0 fs-12">Celebrating our top performers</p>
//             </div>
...
//               {/* Spotlight effects */}
//               {revealStage >= 1 && <div className={`spotlight spotlight-3 ${revealStage >= 1 ? "active" : ""}`}></div>}
//               {revealStage >= 2 && <div className={`spotlight spotlight-2 ${revealStage >= 2 ? "active" : ""}`}></div>}
//               {revealStage >= 3 && <div className={`spotlight spotlight-1 ${revealStage >= 3 ? "active" : ""}`}></div>}
...
//         {/* Right sidebar - Winner details */}
//         <div className="winner-details border">
          
//           <div className="p-3 border-bottom border-block-end-dashed">
//             <h6 className="fw-semibold mb-0">Winner Details</h6>
//             <br />
//           </div>
//           <br />
...
//                     <span className="badge bg-primary">Score: {predictions[0].predicted_score.toFixed(1)}</span>
...
//                 <div className="mb-3">
//                   <i className="ri-trophy-line" style={{ fontSize: '48px', opacity: '0.5' }}></i>
//                 </div>
//                 <h6 className="text-muted">Waiting for winner reveal</h6>
//                 <p className="text-muted small">Winner details will appear here after the podium reveal is complete.</p>
//               </div>
//             )}
//           </div>
//         </div>
...
//           bottom: 0;
//           background: ${
//             revealStage === 3 ? `radial-gradient(circle at center, rgba(255, 255, 255, 0.2) 0%, rgba(255, 255, 255, 0) 70%)` : "none"
//           };
                ...
                <div className="mb-4">
                  ...
                  <ul className="list-group list-group-flush">
                    <li className="list-group-item px-0 d-flex justify-content-between">
                      ...
                      <span>{selectedMember.team_id}</span>
                    </li>
                    <li className="list-group-item px-0 d-flex justify-content-between">
